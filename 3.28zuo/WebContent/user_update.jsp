...
<body>
   ...
   <div id="main">
      ...
      修改用户<br><br>
      <input type="hidden" name="id" value="${updateUser.id}"><br><br>
      用户名:<input type="text" name="username" value="${updateUser.username }"><br><br>
      密码<input type="password" name="password" value="${updateUser.password}"><br><br>

...
<body>
   ...
   <div id="main">
     <div id="main_left">
      ...
      <div id="main_right">
       <form action="CarServlet?flag=zengjia" method="post" enctype="multipart/form-data">
          增加车辆<br><br>
          名称：<input type="text" name="name"/><br><br>
         颜色：<input type="text" name="color"/><br><br>
         价格：<input type="text" name="price" size="5"/>万元<br><br>
